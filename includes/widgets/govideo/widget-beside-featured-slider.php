...
// Creating the widget 
class HoocBesideFeaturedSlider_Widget extends WP_Widget {
 
function __construct() {
	parent::__construct(
	 
	'hooc_beside_featured_slider', 
	 
	__('HC: Area Beside Featured Slider', 'hoo-companion'), 
	 
	array( 'description' => __( 'Posts beside featured mian slider.', 'hoo-companion' ), ) 
	);
}
...
public function widget( $args, $instance ) {
	...
	$defaults = array( 'category' => '0', 'posts_count' => '4', 'taxonomy' =>'category' );
...
public function form( $instance ) {
	...
	<p>
	<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Posts Category Beside Featured Main Slider', 'hoo-companion' ); ?>:</label> 
    <br />
