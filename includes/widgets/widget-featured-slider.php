<?php
// Creating the widget 
class HoocFeaturedSlider_Widget extends WP_Widget {
 
function __construct() {
	parent::__construct(
	 
	'hooc_featured_slider', 
	 
	__('HC: Section Featured Slider', 'hoo-companion'), 
...
public function widget( $args, $instance ) {
	...
	$defaults = array( 'category' => '0', 'posts_count' => '3', 'taxonomy' =>'category' );
	...
	echo '<div class="featured-main-slider count-'.$count.' owl-carousel owl-theme" >';
			...
			<div class="zoom-container">
				<div class="zoom-caption">
					...
					<a href="<?php the_permalink(); ?>">
						<?php echo HooCompanion::get_zoom_icon();?>
					</a>
					<p><?php the_title(); ?></p>
				</div>
				<?php
...
public function form( $instance ) {
	...
	<p>
	<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Featured Main Slider Category', 'hoo-companion' ); ?>:</label> 
    <br />
