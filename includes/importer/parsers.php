 ...
 */
class Hoo_WXR_Parser {
	function parse( $file ) {
		// Attempt to use proper XML parsers first
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new Hoo_WXR_Parser_SimpleXML;
		...
		$parser = new Hoo_WXR_Parser_Regex;
 ...
 */
class Hoo_WXR_Parser_SimpleXML {
	function parse( $file ) {
